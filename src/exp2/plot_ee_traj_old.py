...
def view_trained_reward_traj(perturb_path, path):
    ...
    ee_pose_traj = ee_pose_traj['traj']
...
OPA executed traj 0 with perturb at iter 1:
    python plot_ee_traj.py --path opa_saved_trials_obstacle1/trial_0/ee_pose_traj_iter_0.npy --perturb_path opa_saved_trials_obstacle1/perturb_collection/perturb_traj_iter_1_num_0.npy

Unified:
    python plot_ee_traj.py --path unified_saved_trials_obstacle1/eval_perturbs_1_time_10.0/ee_pose_traj_iter_0_rand_trial_0.npz --perturb_path unified_saved_trials_obstacle1/perturb_collection/perturb_traj_iter_0_num_0.npy
